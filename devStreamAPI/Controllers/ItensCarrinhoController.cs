...
namespace devStreamAPI.Controllers
{
    ...
    public class ItensCarrinhoController : ControllerBase
    {
        ...
        public ItensCarrinhoController(DevStreamAPIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<ItemCarrinho>> PostItemCarrinho(ItemCarrinho itemCarrinho)
        {
            ...
            await RecalculateCarrinhoTotal(itemCarrinho.CarrinhoId);
        ...
        private async Task RecalculateCarrinhoTotal(Guid carrinhoId)
        {
