...
namespace devStreamAPI.Controllers
{
    ...
    public class CarrinhosController : ControllerBase
    {
        ...
        public CarrinhosController(DevStreamAPIContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Carrinhos/ByDataCriacao
        [HttpGet("ByDataCriacao")]
        public async Task<ActionResult<IEnumerable<Carrinho>>> GetCarrinhosByDataCriacao(DateTime dataInicio, DateTime dataFim)
        {
